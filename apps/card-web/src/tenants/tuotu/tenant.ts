...
const knowledgeBase: KnowledgeItem[] = [
  {
    ...
    answer:
      "拓浙 AI 集团围绕 AI 人才与项目孵化、AI 场景服务两大方向，连接青年人才、学习与项目组织、创新赛事和产业伙伴，让真实问题同时成为人才成长与应用验证的起点。",
  ...
  },
  {
    ...
    answer:
      "公开版分为四个协同板块：拓途浙享提供活动、内容与项目入口；智能体学习与项目社群承接训练、组队和实践；浙客松用于真实场景下的创新验证与成果展示；AI 场景服务围绕需求诊断、原型验证、定制开发和持续迭代推进产业共创。",
  ...
  },
  {
    ...
    answer:
      "拓途浙享是生态的线上入口，聚合校园活动与 AI 学习内容，并连接项目、组队和成果展示。部分项目广场与成果沉淀能力仍属于材料中的规划方向，具体开放状态以平台页面为准。",
  ...
  },
  {
    ...
    answer:
      "不同基础的学生可以从公开内容、主题工作坊和基础训练进入，再通过组队、真实项目或浙客松积累实践与作品。有技术基础的参与者可进一步承担项目任务。具体招募、课程、认证和人才机会以当期正式通知为准。",
  ...
  },
  {
    ...
    answer:
      "浙客松是面向真实场景的 AI 创新赛事与项目验证活动，通过跨学科组队、阶段性评审和成果展示，观察人才能力与项目潜力。材料记录首届约 300 人报名、100 人正式参赛；具体赛题、证明与后续权益以当期规则为准。",
  ...
  },
  {
    ...
    answer:
      "AI 场景服务从具体业务问题出发，可包括需求梳理、场景评估、方案设计、原型验证、定制开发、数据资产整理和持续迭代。项目目标、周期与验收指标需要结合业务范围、数据条件和合规要求单独约定，不使用统一准确率或效果承诺。",
  ...
  },
  {
    ...
    answer:
      "企业可提交 AI 应用场景、联合发布真实赛题、共建项目实践，或开展青年人才交流。合作通常经过需求沟通、场景评估、范围确认、团队匹配、阶段验证和成果复盘；费用、周期、数据使用、知识产权、保密与验收方式需按项目另行确认。",
  ...
  },
  {
    ...
    answer:
      "据 2026 年 7 月内部材料，拓途浙享平台注册用户 2300+、累计收录校园活动 700+；首届浙客松约 300 人报名、100 人正式参赛。这些是阶段性资料口径，不是实时接口数据，正式发布前仍需复核截止日期和统计方式。",
  ...
  },
  {
    ...
    answer:
      "现有材料描述项目从浙江大学校园场景出发，并讨论产学协同与相关校内资源，但不足以证明浙江大学官方主体身份或统一授权。公开关系、合作称谓和标识使用应以集团及相关单位最终确认的文件为准。",
  ...
  },
  {
    ...
    answer:
      "不保证。项目、赛事和人才合作可能提供成果评价、证明或交流机会，但具体认证名称、适用范围和人才权益均以对应活动及合作方正式规则为准，不作内推、录用、投资或孵化结果承诺。",
  ...
  },
  {
    ...
    answer:
      "如需联系或加入拓浙 AI 集团，可先访问拓途浙享平台 tuotuzju.com 查看公开内容、活动与报名入口。现有资料尚未提供经确认可公开的集团联系电话、邮箱、微信、联系人或统一入群入口；正式上线前需要由集团补齐官方商务与加入渠道。",
...
export const tuotuTenant = defineTenant({
  ...
  assistant: {
    ...
    launcherLabel: "问资料助手",
    initialMessage: {
      text: "你好，我是拓浙 AI 集团资料助手。我会根据 2026 年 7 月整合材料回答，并区分已记录事实、规划方向与待确认事项。",
    ...
    fallback: {
      answer:
        "现有资料暂未覆盖这个问题，我不能根据猜测补充。你可以换个问法，或访问 tuotuzju.com 查看公开信息；正式商务问题还需要由集团提供人工联系入口。",
      source: "资料边界规则",
    },
  },
  footer: {
